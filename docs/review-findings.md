...
- **Files**: `crates/fterm/src/command/ssh.rs`, `crates/fterm/src/command/scp.rs`
...
- **Files**: `crates/fterm-ssh-config/src/config/connection.rs`
...
- **Files**: `crates/fterm/src/external.rs`
...
- **Files**: `crates/fterm-ssh-config/src/config/include.rs`
...
- **Files**: `crates/fterm/src/command/fgen.rs`
...
- **Files**: `crates/fterm/src/command/ssh.rs`, `crates/fterm/src/command/scp.rs`, `crates/fterm-core/src/util/ssh_env.rs`
...
- **Files**: `crates/fterm/src/command/ssh.rs`, `crates/fterm/src/command/scp.rs`, `crates/fterm-core/src/util/path.rs`
...
- **Files**: `crates/fterm/src/command/scp.rs`, `crates/fterm-core/src/util/splash.rs`
...
- **Files**: `crates/fterm-ssh-config/src/validate/identity.rs`
...
- **Files**: `crates/fterm-ssh-config/src/validate/control_path.rs`
...
- **Files**: `crates/fterm/src/command/ssh.rs`, `crates/fterm/src/command/scp.rs`, `crates/fterm-session/src/tmux/pane.rs`
- **Fix**: Added `pane::get_title()`, save original before overwriting, restore on teardown.
- **Status**: DONE

### P3-02: No agent key caching

- **Files**: `crates/fterm/src/command/ssh.rs`
...
- **Files**: `crates/fterm-core/src/util/splash.rs`
- **Status**: DONE

### P3-04: Connect banner missing Config Name and Command args

- **Files**: `crates/fterm-core/src/util/splash.rs`, `crates/fterm/src/command/ssh.rs`
...
- **Files**: `crates/fterm-core/src/util/splash.rs`, `crates/fterm/src/command/scp.rs`
- **Status**: DONE

### P3-06: SCP log path missing tmux identifiers

- **Files**: `crates/fterm/src/command/scp.rs`, `crates/fterm-session/src/tmux/session.rs`
...
- **Files**: `crates/fterm/src/command/scp.rs`
- **Status**: DONE

### P3-08: SCP missing user@host format construction

- **Files**: `crates/fterm/src/command/scp.rs`, `crates/fterm-core/src/util/scp_args.rs`
...
- **Files**: `crates/fterm/src/command/flog.rs`, `crates/fterm-session/src/util/files.rs`
...
- **Files**: `crates/fterm/src/command/flog.rs`, `crates/fterm-core/src/util/log_dir.rs`
